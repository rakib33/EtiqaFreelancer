...
namespace EtiqaFreelancerApi.DataContext
{
    public class FreelancerContext : DbContext
    {
        ...
        {
            optionsBuilder.UseSqlServer("Data Source=eu-az-sql-serv1.database.windows.net;Initial Catalog=dcy8k5s7tqgue9h;User ID=uyf63hof7fhkbqj;Password=uwtbMW@0wlnYUklMB40aoOVc!;Integrated Security=True");
